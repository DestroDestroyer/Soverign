 ...
 * ambitions / communication / rhythm / tools / what-sovereign-does).
 *
 ...
 * "About the user" markdown block injected into Sovereign's system prompt.
 */
...
export const USER_PROFILE_QUESTIONS: UserProfileQuestion[] = [
  {
    ...
    prompt: 'What should SOVEREIGN call you?',
  ...
  },
  {
    ...
    step_title: 'Identity',
    label: 'Pronouns',
    prompt: 'What pronouns do you want SOVEREIGN to use, if any?',
  ...
  },
  {
    ...
    prompt: 'What location or timezone should SOVEREIGN keep in mind?',
  ...
  },
  {
    ...
    description: 'Short-term outcomes that SOVEREIGN should optimize around.',
    placeholder: 'What should SOVEREIGN help push forward?',
    multiline: true,
  },
  {
    ...
    prompt: 'How do you want SOVEREIGN to communicate with you?',
  ...
  },
  {
    ...
    placeholder: 'What should SOVEREIGN not do?',
    multiline: true,
  },
  {
    ...
    prompt: 'What routines, limits, or constraints should SOVEREIGN know?',
  ...
  },
  {
    ...
    description: 'Software, devices, languages, frameworks, and workflows SOVEREIGN should assume.',
  ...
  },
  {
    ...
    placeholder: 'Who should SOVEREIGN keep in mind?',
    multiline: true,
  },
  {
    id: 'anything_else',
    ...
    step_title: 'Context',
    label: 'Anything Else',
    prompt: 'What else should SOVEREIGN know to be useful from day one?',
 ...
 * intent classifier — both paths get the same context so Sovereign is
