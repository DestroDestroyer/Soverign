...
An adaptive personality system for Sovereign that learns user preferences and adapts communication style over time.
...
// Initialize database
initDatabase('./data/sovereign.db');
...
See [docs/PERSONALITY_ENGINE.md](~/sovereign/docs/PERSONALITY_ENGINE.md) for full documentation.
