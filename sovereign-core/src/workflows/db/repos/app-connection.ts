 ...
 * Sovereign' keychain will be layered in step 15 by wrapping serialize/deserialize
 * here. The credential adapter (also step 15) will compose this repo with
 * Sovereign' existing OAuth stores so that pieces like Gmail/Telegram see the
 * tokens Sovereign already manages, without users connecting twice.
 */
