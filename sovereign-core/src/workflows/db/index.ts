/**
 * Workflow tables share the single Sovereign SQLite database (`~/.sovereign/sovereign.db`)
...
/**
 * Returns the shared Sovereign DB (same instance as vault's `getDb`). Workflow
...
/**
 * Closes the shared Sovereign DB. Equivalent to vault's `closeDb`. Tests call
