...
This directory contains a vendored subtree of the [Activepieces](https://github.com/activepieces/activepieces) project, used as the foundation of the Sovereign Workflow system.
...
- `packages/server/api` -- NestJS HTTP server. Replaced by integration into the Sovereign daemon's HTTP surface (Phase 2).
...
Plus the Sovereign-native pieces (Phase 3): `sovereign-ask`, `sovereign-agent`, `sovereign-tool`, `sovereign-context`, `sovereign-notify`, `sovereign-trigger`.
