/**
 * `@sovereignpieces/piece-sovereign-test` -- a fixture piece used only by the
 ...
 * packages/pieces/sovereign/test/ next to the production Sovereign pieces so the
...
export const sovereignTestPiece = createPiece({
