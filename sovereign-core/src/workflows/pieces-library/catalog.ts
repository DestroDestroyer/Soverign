...
export interface CatalogEntry {
  /**
   * Stable Sovereign-side id. URL slug, manifest key. NEVER rename once shipped --
  ...
  iconUrl?: string;
  /**
   * Exact version Sovereign last tested end-to-end. For verified pieces this
...
/** Look up a catalog entry by Sovereign-side id. Returns null when missing. */
