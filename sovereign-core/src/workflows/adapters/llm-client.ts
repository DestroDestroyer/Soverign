/**
 * Adapter: PieceLlmClient over Sovereign' LLMManager.
 *
 ...
 * text content. Streaming and tool use are out of scope for sovereign-ask.
 */
...
export class SovereignLlmClient implements PieceLlmClient {
 ...
 * blocks are dropped -- sovereign-ask is a text piece. If there's no text at
