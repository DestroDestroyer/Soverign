/**
 * Tests for `SovereignWorkflowRunnerAdapter`.
 *
...
import { SovereignWorkflowRunnerAdapter, WorkflowRunnerError } from "./workflow-runner";
...
describe("SovereignWorkflowRunnerAdapter", () => {
  let adapter: SovereignWorkflowRunnerAdapter;

  beforeEach(() => {
    initWorkflowDb(":memory:");
    adapter = new SovereignWorkflowRunnerAdapter();
  });
