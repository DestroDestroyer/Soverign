 ...
 * the real Sovereign pieces. Gated on `SOVEREIGN_TEST_ENGINE_BUILD=1` because
...
const piecesAlreadyBuilt = existsSync(
  resolve(ENGINE_BUILD_PATHS.VENDOR_PACKAGES, "pieces/sovereign/ask/dist/src/index.js"),
);
...
const FIXTURE_TO_REAL: Record<string, string> = {
  "sovereign-ask": "@sovereignpieces/piece-sovereign-ask",
  "sovereign-notify": "@sovereignpieces/piece-sovereign-notify",
  "sovereign-trigger": "@sovereignpieces/piece-sovereign-trigger",
};
...
describe("sampleCatalog drift vs real piece metadata", () => {
  ...
  test.skipIf(skipE2eTests)(
    ...
    async () => {
      const pieceRoots = [resolve(ENGINE_BUILD_PATHS.VENDOR_PACKAGES, "pieces/sovereign")];
