/**
 * In-memory recent-events buffer that backs the `/v1/sovereign/events/poll`
 * route used by the `sovereign-trigger:on_event` polling trigger.
 *
 * The daemon's existing `SovereignEventBusAdapter` is publish/subscribe; this
