...
describe("SandboxApi routes (B2: connections, store, flows)", () => {
  ...
  beforeAll(async () => {
    ...
    // Stub Sovereign source so sovereign:test resolves to a fake OAuth2 connection.
    resolver.register({
      id: "test",
      canResolve: (e) => e === "sovereign:test",
      resolve: async () => ({
        type: "OAUTH2",
  ...
  test("GET /v1/worker/app-connections/:externalId resolves a Sovereign source", async () => {
    const r = await authedFetch("/v1/worker/app-connections/sovereign%3Atest");
    expect(r.status).toBe(200);
    const body = (await r.json()) as { externalId: string; status: string; value: { type?: string; access_token?: string } };
    expect(body.externalId).toBe("sovereign:test");
...
describe("SandboxApi routes (B3: files, waitpoints, logs)", () => {
  ...
  beforeAll(async () => {
    process.env.SOVEREIGN_WORKFLOW_DATA_DIR = `/tmp/sovereign-sandbox-test-${Math.random().toString(36).slice(2, 10)}`;
    initWorkflowDb(":memory:");
    signer = new EngineTokenSigner();
    registry = new SandboxRegistry();
    api = new SandboxApi({
  ...
  afterAll(async () => {
    await api.stop();
    closeWorkflowDb();
    delete process.env.SOVEREIGN_WORKFLOW_DATA_DIR;
  });
...
describe("SandboxApi routes (G: sovereign-tool/notify/context)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/sovereign/tools/invoke calls injected fn and returns its reply", async () => {
    const r = await authedFetch("/v1/sovereign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/tools/invoke 400 on missing toolName", async () => {
    const r = await authedFetch("/v1/sovereign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/tools/invoke 400 on non-object params", async () => {
    const r = await authedFetch("/v1/sovereign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/notify dispatches and surfaces delivery report", async () => {
    const r = await authedFetch("/v1/sovereign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        message: "hi",
  ...
  test("POST /v1/sovereign/notify defaults channels to ['auto'] and priority to 'normal'", async () => {
    const r = await authedFetch("/v1/sovereign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/notify 400 on unknown channel", async () => {
    const r = await authedFetch("/v1/sovereign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/vault-search forwards filter to provider", async () => {
    const r = await authedFetch("/v1/sovereign/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/vault-search 400 on invalid type", async () => {
    const r = await authedFetch("/v1/sovereign/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/vault-get-entity forwards id", async () => {
    const r = await authedFetch("/v1/sovereign/context/vault-get-entity", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/awareness-recent forwards limit/since", async () => {
    const r = await authedFetch("/v1/sovereign/context/awareness-recent", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/commitments-list forwards status filter", async () => {
    const r = await authedFetch("/v1/sovereign/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/context/commitments-list 400 on invalid status", async () => {
    const r = await authedFetch("/v1/sovereign/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (G unconfigured -> 503)", () => {
  ...
  test("context routes without provider return 503", async () => {
    for (const path of [
      "/v1/sovereign/context/vault-search",
      "/v1/sovereign/context/vault-get-entity",
      "/v1/sovereign/context/awareness-recent",
      "/v1/sovereign/context/commitments-list",
    ]) {
...
describe("SandboxApi routes (H: sovereign-agent/trigger)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/sovereign/agent/delegate forwards goal/role/maxIterations", async () => {
    const r = await authedFetch("/v1/sovereign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/agent/delegate 400 on missing goal", async () => {
    const r = await authedFetch("/v1/sovereign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/agent/delegate 400 on non-integer maxIterations", async () => {
    const r = await authedFetch("/v1/sovereign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/events/poll forwards eventType+filter+since", async () => {
    pollReply = {
      events: [
    ...
    const r = await authedFetch("/v1/sovereign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  test("POST /v1/sovereign/events/poll 400 on missing eventType", async () => {
    const r = await authedFetch("/v1/sovereign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/events/poll 400 on negative since", async () => {
    const r = await authedFetch("/v1/sovereign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/workflows/start dispatches with flowId and payload", async () => {
    const r = await authedFetch("/v1/sovereign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/sovereign/workflows/start 400 when flowId is missing", async () => {
  ...
  test("POST /v1/sovereign/workflows/start 400 when flowId is empty", async () => {
    const r = await authedFetch("/v1/sovereign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (workflows/start error mapping)", () => {
  ...
  async function start(): Promise<Response> {
    return authedFetch("/v1/sovereign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi /v1/sovereign/* envelope hardening (G+H review #7)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  const JSON_POST_PATHS = [
    "/v1/sovereign/llm/chat",
    "/v1/sovereign/tools/invoke",
    "/v1/sovereign/notify",
    "/v1/sovereign/context/vault-search",
    "/v1/sovereign/context/vault-get-entity",
    "/v1/sovereign/context/awareness-recent",
    "/v1/sovereign/context/commitments-list",
    "/v1/sovereign/agent/delegate",
    "/v1/sovereign/events/poll",
    "/v1/sovereign/workflows/start",
  ] as const;

  test("each /v1/sovereign/* POST returns 400 on malformed JSON", async () => {
  ...
  test("each /v1/sovereign/* POST returns 400 on a non-object body", async () => {
    for (const path of JSON_POST_PATHS) {
      const r = await authedFetch(path, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  test("/v1/sovereign/events/poll headOnly mode skips 'since' and returns the head cursor", async () => {
    const r = await authedFetch("/v1/sovereign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("/v1/sovereign/events/poll without 'since' and without headOnly returns 400", async () => {
    const r = await authedFetch("/v1/sovereign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("each /v1/sovereign/* POST handles a 256KB+ payload without crashing", async () => {
    // The store route caps at 500KB; the sovereign routes have no explicit cap
