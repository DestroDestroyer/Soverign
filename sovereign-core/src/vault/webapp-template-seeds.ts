 ...
 *   2. User overrides: ~/.sovereign/webapp-templates/ (user-created or customized)
 *
 ...
 *   2. User overrides from ~/.sovereign/webapp-templates/
...
export function seedWebappTemplates(): void {
  ...
  const userDir = join(homedir(), '.sovereign', 'webapp-templates');
