...
The Role Engine is a core component of Project Sovereign that defines, loads, and manages AI agent roles with their permissions, responsibilities, and behavior patterns.
