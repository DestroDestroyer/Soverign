 ...
 * Tokens stored at ~/.sovereign/google-tokens.json
 */
...
export class GoogleAuth {
  ...
  constructor(
    ...
    this.tokensPath = opts?.tokensPath ?? path.join(os.homedir(), '.sovereign', 'google-tokens.json');
   ...
   * `SovereignGoogleConnectionSource` to surface the full OAuth2-shaped value
