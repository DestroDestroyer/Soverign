            ...
            <div style={{ flex: 1, padding: "8px", overflow: "auto" }}>
              {!projectId ? (
                ...
                <div style={emptyStyle}>
                  Chat with SOVEREIGN about this project. Your messages will be scoped to the active project.
                </div>
              ) : (
            ...
            <div style={{ padding: "8px", borderTop: "1px solid var(--j-border)" }}>
              <div style={{ display: "flex", gap: "6px" }}>
                <input
                  ...
                  placeholder={projectId ? "Ask SOVEREIGN to build..." : "Select a project first"}
