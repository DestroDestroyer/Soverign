...
export function MessageBubble({ message }: Props) {
  ...
  // User / SOVEREIGN messages
  return (
    <div className={`chat-msg ${isUser ? "chat-msg-user" : "chat-msg-sovereign"}`}>
      {/* SOVEREIGN sender row */}
      {!isUser && (
        <div className="chat-sender">
          <div className="chat-sender-orb" />
          <span className="chat-sender-name">SOVEREIGN</span>
      ...
      {/* Bubble */}
      <div className={`chat-bubble ${isUser ? "chat-bubble-user" : "chat-bubble-sovereign"}`}>
