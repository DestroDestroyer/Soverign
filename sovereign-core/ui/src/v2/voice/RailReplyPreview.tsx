...
/**
 * Phase 6.5.5 — surfaces the LAST SENTENCE of Sovereign's most recent reply
 ...
 * the thread; this preview is a peek so the user knows Sovereign answered
...
export function RailReplyPreview() {
  ...
  return (
    <div
      ...
      role="status"
      aria-live="polite"
      aria-label="Sovereign just said"
