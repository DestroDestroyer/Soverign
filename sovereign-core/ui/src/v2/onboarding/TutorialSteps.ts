 ...
 *   - `narration`      what Sovereign speaks AND the bubble shows
...
export interface TutorialStep {
   ...
   *  spotlight while Sovereign explains it. */
...
export const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    target: "viewport",
    narration:
      "Welcome to Sovereign. I'll take you through the dashboard in about ten minutes. You can press Next, say 'next', or just try the highlighted feature yourself to advance.",
  },
  {
    id: "thread",
    target: ".v2-thread",
  ...
  },
  {
    ...
    target: ".v2-rail",
    narration:
      "I'm always listening for the wake word. Say 'Sovereign' to interrupt me at any time, or hold the spacebar to push-to-talk. The orb shows my voice state — idle, listening, thinking, speaking.",
    prefer: "left",
  },
  {
    id: "inline-card",
  ...
  // user sees each surface behind the spotlight while Sovereign explains
