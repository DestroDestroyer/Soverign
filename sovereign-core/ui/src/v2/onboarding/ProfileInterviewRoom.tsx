 ...
 * MicOrb that pulses while Sovereign speaks; live transcript bubbles
 * for the conversation; type-or-talk composer at the bottom; Skip
 * button always available.
 *
 * Voice flow: Sovereign speaks → orb pulses speaking → on TTS end the
        ...
        <div className="v2-interview__wrap">
          <div className="v2-interview__done">
            ...
            <p className="v2-interview__done-body">
              {session.farewell ||
                "I have plenty to start with. Welcome to Sovereign."}
            </p>
    ...
    <div className="v2-interview" role="dialog" aria-modal="true" aria-label="Onboarding interview">
      <div className="v2-interview__wrap">
        <header className="v2-interview__head">
          <div className="v2-interview__brand">SOVEREIGN · onboarding</div>
...
function phaseLabel(phase: string): string {
  switch (phase) {
    ...
    case "thinking": return "Sovereign is thinking…";
    case "speaking": return "Sovereign is speaking — listen up";
