...
export function SetupRoom({ onComplete }: { onComplete: () => void }) {
  ...
  // configured, so Sovereign can't chat until the user wires a provider
  // up in Settings — but they reach the dashboard immediately.
  const handleSkipSetup = async () => {
    if (
      !confirm(
        "Skip setup? Sovereign won't be able to respond until you configure an LLM in Settings. You can re-run onboarding any time from Settings.",
      )
    ) {
      return;
    }
    ...
    <div className="v2-setup" role="dialog" aria-modal="true" aria-label="First-run setup">
      <div className="v2-setup__wrap">
        <header className="v2-setup__head">
          <div className="v2-setup__brand">SOVEREIGN</div>
        ...
        {screen === "llm" ? (
          <section className="v2-setup__screen">
            <h1 className="v2-setup__title">Pick an LLM to power Sovereign.</h1>
          ...
          <section className="v2-setup__screen">
            <h1 className="v2-setup__title">How should Sovereign hear you?</h1>
            <p className="v2-setup__sub">
            ...
            {(sttChoice === "openai" || sttChoice === "groq") && (
              <div className="v2-setup__field">
                ...
                />
                <p className="v2-setup__hint">
                  Stored locally in your Sovereign config — never sent anywhere
          ...
          <section className="v2-setup__screen">
            <h1 className="v2-setup__title">Should Sovereign speak to you?</h1>
            <p className="v2-setup__sub">
            ...
            <div className="v2-setup__tts-grid" role="radiogroup">
              ...
              <ChoiceCard
                ...
                icon={Volume2}
                title="Edge TTS"
                body="Free, clean, ships with Sovereign. Pick a voice below."
              />
              <ChoiceCard
                id="elevenlabs"
