...
export function useSettingsData() {
  ...
  const setTelegram = useCallback(
    async (input: {
      ...
      try {
        ...
        return {
          ok: true,
          message: "Telegram saved. Restart Sovereign to apply.",
  ...
  const setDiscord = useCallback(
    async (input: {
      ...
      try {
        ...
        return {
          ok: true,
          message: "Discord saved. Restart Sovereign to apply.",
          restartRequired: true,
        };
      } catch (err) {
        return { ok: false, message: err instanceof Error ? err.message : "Failed" };
  ...
  const setSTTProvider = useCallback(
    async (
      ...
      try {
        ...
        return {
          ok: true,
          message: `STT set to ${provider}. Restart Sovereign to apply.`,
          restartRequired: true,
        };
      } catch (err) {
        return { ok: false, message: err instanceof Error ? err.message : "Failed" };
  ...
  const disconnectGoogle = useCallback(async (): Promise<ActionResult> => {
    try {
      ...
      return {
        ok: true,
        message: "Disconnected. Restart Sovereign to deactivate observers.",
        restartRequired: true,
      };
    } catch (err) {
      return { ok: false, message: err instanceof Error ? err.message : "Failed" };
