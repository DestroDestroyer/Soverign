        ...
        <div className="v2-set__section-head">
          <div>
            ...
            <div className="v2-set__section-sub">
              Durable context Sovereign uses for every conversation. Not a one-shot — refine it any time.
            </div>
          </div>
      ...
      {editing && currentStep ? (
        ...
        <section className="v2-set__section">
          <p className="v2-set__hint">
            No user profile saved yet. Start the wizard to give Sovereign a strong initial
    ...
    <section className="v2-set__section">
      <div className="v2-set__section-head">
        <div>
          ...
          <div className="v2-set__section-sub">
            Re-run the conversational interview to refresh what Sovereign knows about
