...
export function GeneralTab({
  ...
  const handleRestart = async () => {
    if (!confirm("Restart Sovereign now? Your dashboard will reconnect after a few seconds.")) return;
    setRestarting(true);
        ...
        <div className="v2-set__section-head">
          <div>
            ...
            <div className="v2-set__section-sub">
              Keepalive that runs Sovereign in the background after the terminal closes.
            </div>
          </div>
          {autostart && (
            <span
        ...
        {autostart ? (
          <>
            ...
            <div style={{ display: "flex", gap: "var(--s-2)", flexWrap: "wrap" }}>
              ...
              >
                {restarting ? "Restarting..." : "Restart Sovereign"}
              </button>
              <button
                type="button"
      ...
      <section className="v2-set__section">
        <div className="v2-set__section-head">
          <div>
            ...
            <div className="v2-set__section-sub">
              How often Sovereign checks in with you proactively.
            </div>
          </div>
        </div>
 ...
 * onboarding flow without nuking `~/.sovereign/`. The same reset is also
    ...
    <section className="v2-set__section">
      <div className="v2-set__section-head">
        <div>
          ...
          <div className="v2-set__section-sub">
            Replay any phase of first-run onboarding. Useful after Sovereign
