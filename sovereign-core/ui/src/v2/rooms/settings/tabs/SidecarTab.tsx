...
export function SidecarTab({
  ...
  const handleRevoke = async (id: string, name: string) => {
    if (!confirm(`Revoke sidecar "${name}"? It will lose access to Sovereign.`)) return;
        ...
        <div className="v2-set__section-head">
          <div>
            ...
            <div className="v2-set__section-sub">
              Run the resulting token on the target machine to extend Sovereign there.
            </div>
          </div>
        </div>
        ...
        {enrollResult && (
          <div className="v2-set__token-box">
            ...
            <code className="v2-set__code v2-set__code--block">
              sovereign --token {enrollResult.token}
            </code>
