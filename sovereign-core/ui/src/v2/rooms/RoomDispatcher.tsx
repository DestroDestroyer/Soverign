...
const ROOM_META: Record<RoomKey, RoomMeta> = {
  ...
  memory: {
    ...
    description:
      "What Sovereign knows. Browse entities, facts, and relationships, or look at the knowledge constellation as a whole.",
  },
  authority: {
    title: "Authority",
  ...
  calendar: {
    ...
    description: "Your upcoming week alongside commitments Sovereign is tracking.",
  },
  goals: {
    title: "Goals",
