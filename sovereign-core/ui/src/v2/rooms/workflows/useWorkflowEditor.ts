...
export interface PieceCatalogActionOrTrigger {
   ...
   * been run. Actions populate `outputSample` (Sovereign extension to AP);
   ...
   * whose envelope shape depends on a config value (sovereign-trigger
 ...
 * connection-less pieces (sovereign-ask, schedule, code, webhook). The
