/**
 * Library panel: tiered list of activepieces community pieces a Sovereign user
 ...
 *
 * Pieces install via npm at runtime into `~/.sovereign/pieces/`; this panel
        ...
        <>
          ...
          <section className="wf-lib__section">
            ...
            <p className="wf-lib__section-hint">
              Hand-reviewed by Sovereign maintainers and smoke-tested against the engine.
            </p>
            {verified.length === 0 ? (
            ...
            {showCommunity ? (
              <>
                <p className="wf-lib__section-hint wf-lib__section-hint--warn">
                  ...
                  sandbox. They haven't been individually reviewed by Sovereign -- check
