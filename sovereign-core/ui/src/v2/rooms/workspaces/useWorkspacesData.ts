...
export function useWorkspacesData() {
  ...
  // collapse, trim. Lets "sovereign landing" find "sovereign-landing" and
  // "sovereign's landing" find the same.
      const norm = (s: string) =>
      ...
      //    matching "sovereign-landing" and full query matching a longer name)
