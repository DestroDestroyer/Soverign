 ...
 * ambitions / communication / rhythm / tools / what-soverign-does).
 *
 ...
 * "About the user" markdown block injected into Soverign's system prompt.
 */
...
export const USER_PROFILE_QUESTIONS: UserProfileQuestion[] = [
  {
    ...
    prompt: 'What should SOVERIGN call you?',
  ...
  },
  {
    ...
    step_title: 'Identity',
    label: 'Pronouns',
    prompt: 'What pronouns do you want SOVERIGN to use, if any?',
  ...
  },
  {
    ...
    prompt: 'What location or timezone should SOVERIGN keep in mind?',
  ...
  },
  {
    ...
    description: 'Short-term outcomes that SOVERIGN should optimize around.',
    placeholder: 'What should SOVERIGN help push forward?',
    multiline: true,
  },
  {
    ...
    prompt: 'How do you want SOVERIGN to communicate with you?',
  ...
  },
  {
    ...
    placeholder: 'What should SOVERIGN not do?',
    multiline: true,
  },
  {
    ...
    prompt: 'What routines, limits, or constraints should SOVERIGN know?',
  ...
  },
  {
    ...
    description: 'Software, devices, languages, frameworks, and workflows SOVERIGN should assume.',
  ...
  },
  {
    ...
    placeholder: 'Who should SOVERIGN keep in mind?',
    multiline: true,
  },
  {
    id: 'anything_else',
    ...
    step_title: 'Context',
    label: 'Anything Else',
    prompt: 'What else should SOVERIGN know to be useful from day one?',
 ...
 * intent classifier — both paths get the same context so Soverign is
