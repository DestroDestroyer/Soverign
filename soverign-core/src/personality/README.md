...
An adaptive personality system for Soverign that learns user preferences and adapts communication style over time.
...
See [docs/PERSONALITY_ENGINE.md](~/soverign/docs/PERSONALITY_ENGINE.md) for full documentation.
