 ...
 *   2. User overrides: ~/.soverign/webapp-templates/ (user-created or customized)
 *
 ...
 *   2. User overrides from ~/.soverign/webapp-templates/
...
export function seedWebappTemplates(): void {
  ...
  const userDir = join(homedir(), '.soverign', 'webapp-templates');
