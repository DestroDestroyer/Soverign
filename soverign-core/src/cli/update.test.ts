...
describe('runUpdate — bun-global', () => {
  test('dispatches `bun update -g @usesoverign/brain`', async () => {
    ...
    expect(calls[0]!.cmd).toEqual(['bun', 'update', '-g', '@usesoverign/brain']);
  });
