/**
 * Tests for `SoverignWorkflowRunnerAdapter`.
 *
...
import { SoverignWorkflowRunnerAdapter, WorkflowRunnerError } from "./workflow-runner";
...
describe("SoverignWorkflowRunnerAdapter", () => {
  let adapter: SoverignWorkflowRunnerAdapter;

  beforeEach(() => {
    initWorkflowDb(":memory:");
    adapter = new SoverignWorkflowRunnerAdapter();
  });
