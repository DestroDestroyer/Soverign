/**
 * Adapter: PieceLlmClient over Soverign' LLMManager.
 *
 ...
 * text content. Streaming and tool use are out of scope for soverign-ask.
 */
...
export class SoverignLlmClient implements PieceLlmClient {
 ...
 * blocks are dropped -- soverign-ask is a text piece. If there's no text at
