/**
 * Phase L plumbing smoke (gated on SOVERIGN_TEST_ENGINE_BUILD=1).
 *
 ...
 * dragging in `googleapis` and friends. Uses the `soverign-validate` test
 ...
 *   - The engine resolves `{{connections['soverign:validate']}}` against the
