/**
 * Workflow tables share the single Soverign SQLite database (`~/.soverign/soverign.db`)
...
/**
 * Returns the shared Soverign DB (same instance as vault's `getDb`). Workflow
...
/**
 * Closes the shared Soverign DB. Equivalent to vault's `closeDb`. Tests call
