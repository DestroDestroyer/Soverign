 ...
 * the real Soverign pieces. Gated on `SOVERIGN_TEST_ENGINE_BUILD=1` because
...
const piecesAlreadyBuilt = existsSync(
  resolve(ENGINE_BUILD_PATHS.VENDOR_PACKAGES, "pieces/soverign/ask/dist/src/index.js"),
);
...
const FIXTURE_TO_REAL: Record<string, string> = {
  "soverign-ask": "@soverignpieces/piece-soverign-ask",
  "soverign-notify": "@soverignpieces/piece-soverign-notify",
  "soverign-trigger": "@soverignpieces/piece-soverign-trigger",
};
...
describe("sampleCatalog drift vs real piece metadata", () => {
  ...
  test.skipIf(skipE2eTests)(
    ...
    async () => {
      const pieceRoots = [resolve(ENGINE_BUILD_PATHS.VENDOR_PACKAGES, "pieces/soverign")];
