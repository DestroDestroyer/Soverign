/**
 * In-memory recent-events buffer that backs the `/v1/soverign/events/poll`
 * route used by the `soverign-trigger:on_event` polling trigger.
 *
 * The daemon's existing `SoverignEventBusAdapter` is publish/subscribe; this
