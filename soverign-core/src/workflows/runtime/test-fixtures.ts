 ...
 * Soverign-native pieces' shape. Used by composer / manage-workflow / API
...
export function sampleCatalog(): PieceCatalog {
  const entries: PieceCatalogEntry[] = [
    ...
    },
    {
      ...
      actions: {
        notify: {
          ...
          description: "Deliver a message through Soverign's configured channels.",
          inputSchema: {
            fields: [
    ...
    {
      name: "soverign-trigger",
      displayName: "Soverign: Trigger",
      description: "Bridge Soverign events into workflows.",
      actions: {
        run_workflow: {
          name: "run_workflow",
      ...
      triggers: {
        on_event: {
          ...
          description: "Fire the workflow when a Soverign event of the given type is published.",
          inputSchema: {
            fields: [
