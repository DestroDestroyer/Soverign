// THIS FILE IS A SOVERIGN STUB.
// The upstream activepieces engine uses `isolated-vm` (a Node N-API native
// addon) to run user code in a V8 isolate. Soverign runs the engine exclusively
...
// or SANDBOX_CODE_AND_PROCESS -- neither of which Soverign supports. Reset
// AP_EXECUTION_MODE to SANDBOX_PROCESS.

import type { CodeSandbox } from '../../core/code/code-sandbox-common'

const message = 'v8-isolate-code-sandbox is not available in Soverign. Use AP_EXECUTION_MODE=SANDBOX_PROCESS.'
