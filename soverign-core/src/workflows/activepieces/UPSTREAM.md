...
This directory contains a vendored subtree of the [Activepieces](https://github.com/activepieces/activepieces) project, used as the foundation of the Soverign Workflow system.
...
- `packages/server/api` -- NestJS HTTP server. Replaced by integration into the Soverign daemon's HTTP surface (Phase 2).
...
Plus the Soverign-native pieces (Phase 3): `soverign-ask`, `soverign-agent`, `soverign-tool`, `soverign-context`, `soverign-notify`, `soverign-trigger`.
