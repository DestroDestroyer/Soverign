...
describe("SandboxApi routes (B2: connections, store, flows)", () => {
  ...
  beforeAll(async () => {
    ...
    // Stub Soverign source so soverign:test resolves to a fake OAuth2 connection.
    resolver.register({
      id: "test",
      canResolve: (e) => e === "soverign:test",
      resolve: async () => ({
        type: "OAUTH2",
  ...
  test("GET /v1/worker/app-connections/:externalId resolves a Soverign source", async () => {
    const r = await authedFetch("/v1/worker/app-connections/soverign%3Atest");
    expect(r.status).toBe(200);
    const body = (await r.json()) as { externalId: string; status: string; value: { type?: string; access_token?: string } };
    expect(body.externalId).toBe("soverign:test");
...
describe("SandboxApi routes (B3: files, waitpoints, logs)", () => {
  ...
  beforeAll(async () => {
    process.env.SOVERIGN_WORKFLOW_DATA_DIR = `/tmp/soverign-sandbox-test-${Math.random().toString(36).slice(2, 10)}`;
    initWorkflowDb(":memory:");
    signer = new EngineTokenSigner();
    registry = new SandboxRegistry();
    api = new SandboxApi({
  ...
  afterAll(async () => {
    await api.stop();
    closeWorkflowDb();
    delete process.env.SOVERIGN_WORKFLOW_DATA_DIR;
  });
...
describe("SandboxApi routes (G: soverign-tool/notify/context)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/soverign/tools/invoke calls injected fn and returns its reply", async () => {
    const r = await authedFetch("/v1/soverign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/tools/invoke 400 on missing toolName", async () => {
    const r = await authedFetch("/v1/soverign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/tools/invoke 400 on non-object params", async () => {
    const r = await authedFetch("/v1/soverign/tools/invoke", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/notify dispatches and surfaces delivery report", async () => {
    const r = await authedFetch("/v1/soverign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        message: "hi",
  ...
  test("POST /v1/soverign/notify defaults channels to ['auto'] and priority to 'normal'", async () => {
    const r = await authedFetch("/v1/soverign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/notify 400 on unknown channel", async () => {
    const r = await authedFetch("/v1/soverign/notify", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/vault-search forwards filter to provider", async () => {
    const r = await authedFetch("/v1/soverign/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/vault-search 400 on invalid type", async () => {
    const r = await authedFetch("/v1/soverign/context/vault-search", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/vault-get-entity forwards id", async () => {
    const r = await authedFetch("/v1/soverign/context/vault-get-entity", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/awareness-recent forwards limit/since", async () => {
    const r = await authedFetch("/v1/soverign/context/awareness-recent", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/commitments-list forwards status filter", async () => {
    const r = await authedFetch("/v1/soverign/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/context/commitments-list 400 on invalid status", async () => {
    const r = await authedFetch("/v1/soverign/context/commitments-list", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (G unconfigured -> 503)", () => {
  ...
  test("context routes without provider return 503", async () => {
    for (const path of [
      "/v1/soverign/context/vault-search",
      "/v1/soverign/context/vault-get-entity",
      "/v1/soverign/context/awareness-recent",
      "/v1/soverign/context/commitments-list",
    ]) {
...
describe("SandboxApi routes (H: soverign-agent/trigger)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  test("POST /v1/soverign/agent/delegate forwards goal/role/maxIterations", async () => {
    const r = await authedFetch("/v1/soverign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/agent/delegate 400 on missing goal", async () => {
    const r = await authedFetch("/v1/soverign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/agent/delegate 400 on non-integer maxIterations", async () => {
    const r = await authedFetch("/v1/soverign/agent/delegate", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/events/poll forwards eventType+filter+since", async () => {
    pollReply = {
      events: [
    ...
    const r = await authedFetch("/v1/soverign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
  ...
  test("POST /v1/soverign/events/poll 400 on missing eventType", async () => {
    const r = await authedFetch("/v1/soverign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/events/poll 400 on negative since", async () => {
    const r = await authedFetch("/v1/soverign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/workflows/start dispatches with flowId and payload", async () => {
    const r = await authedFetch("/v1/soverign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("POST /v1/soverign/workflows/start 400 when flowId is missing", async () => {
  ...
  test("POST /v1/soverign/workflows/start 400 when flowId is empty", async () => {
    const r = await authedFetch("/v1/soverign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi routes (workflows/start error mapping)", () => {
  ...
  async function start(): Promise<Response> {
    return authedFetch("/v1/soverign/workflows/start", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
describe("SandboxApi /v1/soverign/* envelope hardening (G+H review #7)", () => {
  let api: SandboxApi;
  let signer: EngineTokenSigner;
  let registry: SandboxRegistry;
  ...
  const JSON_POST_PATHS = [
    "/v1/soverign/llm/chat",
    "/v1/soverign/tools/invoke",
    "/v1/soverign/notify",
    "/v1/soverign/context/vault-search",
    "/v1/soverign/context/vault-get-entity",
    "/v1/soverign/context/awareness-recent",
    "/v1/soverign/context/commitments-list",
    "/v1/soverign/agent/delegate",
    "/v1/soverign/events/poll",
    "/v1/soverign/workflows/start",
  ] as const;

  test("each /v1/soverign/* POST returns 400 on malformed JSON", async () => {
  ...
  test("each /v1/soverign/* POST returns 400 on a non-object body", async () => {
    for (const path of JSON_POST_PATHS) {
      const r = await authedFetch(path, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  test("/v1/soverign/events/poll headOnly mode skips 'since' and returns the head cursor", async () => {
    const r = await authedFetch("/v1/soverign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("/v1/soverign/events/poll without 'since' and without headOnly returns 400", async () => {
    const r = await authedFetch("/v1/soverign/events/poll", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  test("each /v1/soverign/* POST handles a 256KB+ payload without crashing", async () => {
    // The store route caps at 500KB; the soverign routes have no explicit cap
