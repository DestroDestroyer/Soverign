...
export interface CatalogEntry {
  /**
   * Stable Soverign-side id. URL slug, manifest key. NEVER rename once shipped --
  ...
  iconUrl?: string;
  /**
   * Exact version Soverign last tested end-to-end. For verified pieces this
...
/** Look up a catalog entry by Soverign-side id. Returns null when missing. */
