 ...
 * Tokens stored at ~/.soverign/google-tokens.json
 */
...
export class GoogleAuth {
  ...
  constructor(
    ...
    this.tokensPath = opts?.tokensPath ?? path.join(os.homedir(), '.soverign', 'google-tokens.json');
   ...
   * `SoverignGoogleConnectionSource` to surface the full OAuth2-shaped value
